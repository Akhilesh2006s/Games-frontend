          ...
          {(result?.isGameComplete || currentGame?.status === 'COMPLETE') ? (
            ...
            <div className="mt-4 rounded-3xl border-2 border-blue-500/70 bg-gradient-to-br from-blue-600/30 via-blue-500/25 to-blue-600/30 p-8 backdrop-blur-md shadow-lg shadow-blue-500/20">
              ...
              <div className="mb-6 text-center">
                {result.result === 'draw' ? (
                  <p className="text-3xl font-bold text-yellow-300 drop-shadow-lg">🤝 Draw!</p>
                ) : result.result === 'host' ? (
              ...
              <div className="flex items-center justify-center gap-8">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className={`rounded-2xl border-3 p-5 shadow-lg ${
                    result.result === 'host' 
                      ...
                      : result.result === 'draw'
                      ? 'border-yellow-400/60 bg-yellow-400/20 shadow-yellow-400/20'
                      : 'border-blue-400/40 bg-blue-500/20 shadow-blue-400/20'
                  }`}>
                    <p className="text-7xl">{handMap[result.hostMove] || '⏳'}</p>
                  </div>
                  <p className="text-sm font-semibold text-white/80 mt-3 capitalize">{result.hostMove}</p>
                </div>
                ...
                <div className="flex flex-col items-center">
                  ...
                  <div className={`rounded-2xl border-3 p-5 shadow-lg ${
                    ...
                    <p className="text-7xl">{handMap[result.guestMove] || '⏳'}</p>
                  </div>
                  <p className="text-sm font-semibold text-white/80 mt-3 capitalize">{result.guestMove}</p>
                </div>
              </div>
